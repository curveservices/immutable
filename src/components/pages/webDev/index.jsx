        ...
        <div className={style.innerHero}>
          <div className={style.textBox}>
            ...
            <p>
              ...
              specializes in tailoring web development solutions, ensuring
      ...
      <section className={style.secondSection}>
        <div className={style.secondInner}>
          <div className={`${second ? style.animSecond : style.secondNone}`}>
            ...
            <p>
              Frustrated with an outdated website that lacks engagement and
      ...
      <section className={style.thirdSection}>
        <div className={style.thirdInner}>
          <div className={style.thirdTextBox}>
            ...
            <p>
              We prioritize transparent communication and strong client
              relationships. Our services feature clear, budget-friendly pricing
              with detailed breakdowns. As your business grows, our scalable
              packages ensure your website consistently meets evolving needs,
