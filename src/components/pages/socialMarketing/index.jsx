      ...
      <section className={style.secondSection}>
        <div className={style.secondInner}>
          <div className={`${second ? style.animSecond : style.secondNone}`}>
            <h1>
              Elevate social presence with our professional template designs.
            </h1>
            <p>
              In the competitive digital landscape, brand distinction is
      ...
      <section className={style.thirdSection}>
        <div className={style.thirdInner}>
          <div className={style.thirdTextBox}>
            ...
            <p>
              We prioritize transparent communication and robust client
              relationships. Our services offer clear, budget-friendly pricing
              with detailed breakdowns. With our scalable packages, your website
              adapts to evolving needs, emphasizing flexibility and alignment
              with your goals as your business expands.
            </p>
          </div>
          <div
