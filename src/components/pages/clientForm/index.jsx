    ...
    <div className="client-discovery-form">
      ...
      <form ref={refForm} onSubmit={handleSubmit} className="discovery-form">
        ...
        {formData.services.includes("AI & Automation Solutions") && (
          <section className="form-section">
            ...
            {formData.aiSolutions.includes("AI Chat Assistants") && (
              <div>
                <label>
                  What is the primary purpose of the AI chatbot? (e.g., customer
                  support, lead generation, etc.)
                  <textarea
        ...
        <section className="form-section">
          ...
          <label>
            What is your budget for this project? (Provide a range if possible)
            <input
              type="text"
              name="budget"
        ...
        <section className="form-section">
          <label>
            <input type="checkbox" name="acknowledgment" required />I understand
            that this is an initial inquiry and not a binding contract.
          </label>
          <label>
