    ...
    return (
        <>
            <div className="policy-page">
                ...
                <p>
                    This privacy policy has been compiled to serve better those who are concerned with how their 'Personally Identifiable Information' (PII) is being used online.
                    PII, as described in US privacy law and information security, is information that can be used on its own or with other information to identify,
                    contact, or locate a single person, or to identify an individual in context.
                    Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle
                ...
                <p>
                    ...
                    Website Address or other details to help you with your experience.
                </p>
                ...
                <p>
                    ...
                    Web browser (if you allow) that enables the site's or service provider's systems to recognize your browser and capture and remember certain information.
                ...
                <p>
                    You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your browser settings. Since every browser is a little different,
                ...
                <p><a href="https://support.google.com/adwordspolicy/answer/1316548?hl=en"> click here </a>for Google support</p>
                <p>
                ...
                <p>
                    ...
                    <ul><li>DoubleClick Platform Integration</li></ul>
                </p>

                <p>
                    We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie)
                ...
                <h2><b> California Online Privacy Protection Act</b></h2>
                <p>CalOPPA is the first state law in the nation to require commercial websites and online services to post a privacy policy.
                    ...
                    that operates websites collecting Personally Identifiable Information from California consumers to post a conspicuous privacy policy on its website stating exactly the
                    information being collected and those individuals or companies with whom it is being shared.
                    <a href=" http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf">  - See more </a>
                </p>
                <h2><b>According to CalOPPA, we agree to the following</b></h2>
                <p>
                    You will be notified of any Privacy Policy changes:
                    <ul>
                        <li>On our Privacy Policy Page</li>
                        <li>Can change your personal information: By logging into your account</li>
                    </ul>
                </p>
                <h2><b>How does our site handle Do Not Track signals?</b></h2>
                <p>
                    ...
                    We don't honor them because: we don't have the technical means.
                </p>
                <h2><b>Does our site allow third-party behavioral tracking?</b></h2>
                <p>
                ...
                <p className='end'>
                    ...
                    If at any time you would like to unsubscribe from receiving future emails, you can email us at hello@immutable-studio.co.uk
                </p>
                <p>
            ...
            <div>
                <Helmet>
                    <title>Privacy Policy - Immutable Studio: Web Development, AI &amp; Automation Solutions Agency</title>
                </Helmet>
            </div>
        </>
    );
