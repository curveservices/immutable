                ...
                return (
                    <div key={item.id}>
                        ...
                        <div className="images">
                            ...
                            <img className="mobile-wireframe" src={item.mobile1} alt="wireframe" />
                            <img className="mobile-wireframe" src={item.mobile2} alt="wireframe" />
                            <img className="mobile-wireframe" src={item.mobile3} alt="wireframe" />
                        </div>
                    </div>
